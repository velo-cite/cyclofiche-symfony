...
final class Version20250419140305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_14B784184BD2A4C0 ON photo (issue_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE issue (id SERIAL NOT NULL, type VARCHAR(255) NOT NULL, location TEXT NOT NULL, city VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, description TEXT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE photo ADD CONSTRAINT FK_14B784184BD2A4C0 FOREIGN KEY (issue_id) REFERENCES issue (id) NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
    }
